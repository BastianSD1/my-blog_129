...
function checksketch(){
    if {
      cursor=move = draw()
          ...
          cursor≠move = <p id="not moving">not moving</p>
...
button=pressed=uptadecanvas(){
  ...
  function uptadecanvas(){
   if (<p id="btn btn warning-reiniciar">reiniciar/p>){
    button=pressed() =console.log(),quick_draw_data_set();
